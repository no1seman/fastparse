...
static auto visit_enum_value_arr(const GraphQLAstEnumValueArr *enum_value, void *user_data) -> int
{
    auto *L = static_cast<lua_State *>(user_data);
    arr_begin(L);
    obj_string(L, "kind", "enum");
    obj_string(L, "value", GraphQLAstEnumValueArr_get_value(enum_value));
    return 1;
}

static void end_visit_enum_value_arr(const GraphQLAstEnumValueArr *enum_value, void *user_data)
{
    auto *L = static_cast<lua_State *>(user_data);
    arr_end(L);
}
...
static auto visit_object_value_arr(const GraphQLAstObjectValueArr *object_value, void *user_data) -> int
{
    auto *L = static_cast<lua_State *>(user_data);
    obj_begin(L);
    obj_string(L, "kind", "inputObject");
...
static void end_visit_object_value_arr(const GraphQLAstObjectValueArr *object_value, void *user_data)
{
    auto *L = static_cast<lua_State *>(user_data);
    obj_end(L, "values");
    arr_end(L);
...
struct GraphQLAstVisitorCallbacks callbacks_test = {
    ...
    .visit_enum_value_arr = visit_enum_value_arr,
    ...
    .visit_object_value_arr = visit_object_value_arr,
    .end_visit_object_value_arr = end_visit_object_value_arr,
